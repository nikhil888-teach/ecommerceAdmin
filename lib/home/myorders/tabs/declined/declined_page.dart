import 'package:adminpanelecommerce/home/myorders/tabs/declined/declineproduct_page.dart';
...
class MyDeclined extends StatefulWidget {
  const MyDeclined({super.key});

  @override
  State<MyDeclined> createState() => _MyDeclinedState();
}

class _MyDeclinedState extends State<MyDeclined> {
  @override
                                ...
                                OutlinedButton(
                                    ...
                                    onPressed: () {
                                      Navigator.of(context)
                                        ...
                                        builder: (context) => MyDeclinedProduct(
                                          orderNo: list[index]
                                                  [Constants.dorderno]
                                              .toString(),
