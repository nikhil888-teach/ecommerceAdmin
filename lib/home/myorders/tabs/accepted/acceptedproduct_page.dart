...
class MyAcceptedProduct extends StatefulWidget {
  const MyAcceptedProduct({super.key});

  @override
  State<MyAcceptedProduct> createState() => _MyAcceptedProductState();
}

class _MyAcceptedProductState extends State<MyAcceptedProduct> {
  @override
